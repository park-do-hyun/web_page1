...
class TestView(TestCase) :
    ...
    def test_comment_update(self):
        ...
        self.assertIn('edit', comment_001_update_btn.text)
        self.assertEqual(comment_001_update_btn.attrs['href'], '/blog/update_com-ment/1/')
    ...
    def test_delete_comment(self):
        ...
        self.assertIn('Delete', rellay_delete_btn_002.text)
        self.asserEqual(
        ...
        self.assertEqual(Comment.objects.count(), 1)
        self.assertEqula(self.post_001.comment_set.count(), 1)

    def test_search(self):
        post_about_python = Post.object.create(
        ...
        self.assertIn('Searcg: 파이썬 (2)', main_area.text)
